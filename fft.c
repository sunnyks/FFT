...
// rfft()
// real value fft
// if forward is true, replaces 2*N real data points in x with N complex values
// representing the positive frequency half of their fourier spectrum
// with x[1] replaced with real part of nyquist freq. value
...
// cfft()
// complex fft
// replaces float array x containing NC complex values (2*NC float values
// alternating real-imaginary) by its fourier transform using recursive method
...
// bit_reverse()
// places float array x containing N/2 complex values into bit-reversed order
void bit_reverse(float* x, long N) {
	float rtemp, itemp;
	long i, j, m;
